...
const Hero = () => {
  useEffect(() => {
    const texts = ["Graphic Designer", "Frontend Developer", "UI/UX Designer", "React Developer", "Digital Creator"];
    let currentIndex = 0;
    let charIndex = 0;
    ...
    <section id="home" className="hero">
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p>I create engaging visual designs, digital experiences, and responsive web interfaces with a focus on clean layouts, strong typography, and visual storytelling.</p>
