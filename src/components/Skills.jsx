...
const Skills = () => {
  ...
  const designSkills = [
    { name: "Graphic Design", icon: "fas fa-palette", percentage: 90, color: "#e67e22" },
    { name: "UI/UX Design", icon: "fas fa-layer-group", percentage: 85, color: "#3498db" },
    { name: "Figma", icon: "fab fa-figma", percentage: 85, color: "#f24e1e" },
    { name: "Illustrator", icon: "fas fa-pen-nib", percentage: 75, color: "#ff9a00" },
    { name: "Branding", icon: "fas fa-trademark", percentage: 80, color: "#9b59b6" },
    { name: "Typography", icon: "fas fa-font", percentage: 85, color: "#2ecc71" },
  ];
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            setIsVisible(true);
            triggerSkillAnimation('technical');
          }
        });
      },
      { threshold: 0.3 }
  ...
  const triggerSkillAnimation = (category) => {
    setAnimatedSkills([]);
    const skillsToAnimate =
      category === 'technical' ? technicalSkills :
      category === 'design' ? designSkills : softSkills;
  ...
  const handleCategoryChange = (category) => {
    ...
    triggerSkillAnimation(category);
  };
  ...
  const getCurrentSkills = () => {
    ...
    if (activeCategory === 'design') return designSkills;
    return softSkills;
  };
